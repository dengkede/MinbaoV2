...
public class UseRegisterListAdapter extends CommonRecycleAdapter<JSONObject> {

    public UseRegisterListAdapter(Activity mContext, Handler mHandler) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UseRegisterListHolder(itemView);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == VIEWTYPE_NORMAL) {
            try {
                ...
                UseRegisterListHolder mHolder = (UseRegisterListHolder) holder;
    ...
    class UseRegisterListHolder extends RecyclerView.ViewHolder {
        ...
        public UseRegisterListHolder(View itemView) {
            super(itemView);
