...
public class RecordReceiveListAdapter extends CommonRecycleAdapter<JSONObject> {

    public RecordReceiveListAdapter(Activity mContext, Handler mHandler) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecordReceiveListHolder(itemView);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == VIEWTYPE_NORMAL) {
            try {
                ...
                RecordReceiveListHolder mHolder = (RecordReceiveListHolder) holder;
    ...
    class RecordReceiveListHolder extends RecyclerView.ViewHolder {
        ...
        public RecordReceiveListHolder(View itemView) {
            super(itemView);
