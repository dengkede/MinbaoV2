...
import com.hlkj.minbao.presenter.RecordReceivePresenter;
import com.hlkj.minbao.ui.activity.GoodsReceiveActivity;
import com.hlkj.minbao.ui.adapter.RecordReceiveListAdapter;
...
public class RecordReceiveFragment extends BaseFragment<RecordReceivePresenter> implements IRecordReceiveView {
    ...
    private RecordReceiveListAdapter mAdapter;
    ...
    @Override
    public RecordReceivePresenter initPresenter() {
        return new RecordReceivePresenter(mContext, mFragmentName, this);
    }

    @Override
    public int getLayoutResId() {
        return R.layout.fragment_record_receive;
    }
        ...
        try {
            ...
            mHandler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        case RecordReceiveListAdapter.MSG_LISTITEM_FOOTVIEW_CLICK:
                            break;
                        case RecordReceiveListAdapter.MSG_LISTITEM_ITEM_CLICK:
                            Intent intent = new Intent(mContext, GoodsReceiveActivity.class);
            ...
            mAdapter = new RecordReceiveListAdapter(getActivity(), mHandler);
...
//                            actionGetList(true);
    ...
    public static RecordReceiveFragment newInstance() {
        ...
        RecordReceiveFragment fragment = new RecordReceiveFragment();
